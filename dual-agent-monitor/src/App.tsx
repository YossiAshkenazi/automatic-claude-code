...
import { ErrorBoundaryWrapper, WebSocketErrorBoundaryWrapper } from './components/ui/ErrorBoundaryWrapper';
...
function App() {
  ...
  return (
    <ErrorBoundaryWrapper componentName="App Main">
      <WebSocketErrorBoundaryWrapper>
    <ResponsiveLayout
