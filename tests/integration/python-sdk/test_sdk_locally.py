...
def test_options():
    ...
    try:
        ...
        print(f"✅ Default options created")
        ...
        print(f"✅ Custom options created")
...
def test_integration_imports():
    ...
    try:
        ...
        print(f"✅ AutomaticClaudeIntegration imported successfully")
...
def test_query_function():
    ...
    try:
        ...
        print(f"✅ query() function imported")
        ...
        if inspect.iscoroutinefunction(query):
            print(f"✅ query() is an async function")
        else:
            print(f"⚠️  query() might not be properly async")
...
def test_examples_exist():
    ...
    if not example_files:
        print(f"❌ No example files found")
        return False
    ...
    try:
        ...
        if hasattr(client, 'run'):
            ...
            if inspect.iscoroutinefunction(client.run):
                print(f"✅ client.run() is async")
            else:
                print(f"❌ client.run() is not async")
                return False
        
        # Test that run_stream exists
        if hasattr(client, 'run_stream'):
            print(f"✅ client.run_stream() exists")
        else:
            print(f"⚠️  client.run_stream() not found")
        
        # Test run_sync exists
        if hasattr(client, 'run_sync'):
            print(f"✅ client.run_sync() exists for synchronous usage")
        else:
            print(f"⚠️  client.run_sync() not found")
...
def main():
    ...
    if passed_count == total_count:
        ...
        print("\n❌ Multiple tests failed. Please check the installation.")
